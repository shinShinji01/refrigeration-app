...
// 20мм — тот же порог, что и ручной зум-минимум (MIN_VIEWBOX_SIZE_MM в
// useShapeEditor.ts): не даёт auto-fit уйти теснее самого тесного вида,
// доступного пользователю через ручной зум.
